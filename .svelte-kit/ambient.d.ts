...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies__layerstack_utils: string;
	...
	export const npm_package_dependencies_layerchart: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		PNPM_HOME: string;
		npm_package_dependencies__layerstack_utils: string;
		NVM_DIR: string;
		USER: string;
		...
		NVM_BIN: string;
		npm_package_dependencies_layerchart: string;
